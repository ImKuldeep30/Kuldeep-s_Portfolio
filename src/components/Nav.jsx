...
const Nav = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50 text-white flex justify-between items-center bg-transparent backdrop-blur-md px-4 sm:px-6 md:px-8 lg:px-20 py-3 h-16 sm:h-20">
      ...
      <div className="hidden lg:flex lg:w-2/5 justify-between items-center">
        <a href="#home" className="cursor-pointer  text-sm lg:text-base hover:scale-110 transition-transform">Home</a>
        <a href="#skills" className="cursor-pointer text-sm lg:text-base  hover:scale-110 transition-transform">Skills</a>
        <a href="#project" className="cursor-pointer text-sm lg:text-base  hover:scale-110 transition-transform">Project</a>
        <a href="#certification" className="cursor-pointer text-sm lg:text-base  hover:scale-110 transition-transform">Certifications</a>
        <a href="#contact" className="cursor-pointer text-sm lg:text-base  hover:scale-110 transition-transform">Contact Me</a>
      </div>
